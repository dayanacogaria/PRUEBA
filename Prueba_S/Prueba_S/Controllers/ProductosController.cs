...
namespace Prueba_S.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodProducto,NomProducto,Activo")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodProducto,NomProducto,Activo")] Producto producto)
        {
